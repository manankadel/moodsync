...
const DisconnectedOverlay = () => (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-x-0 bottom-full mb-4 z-20 flex items-center justify-center gap-2 bg-yellow-900/50 text-yellow-200 py-2 border-t border-b border-yellow-400/30">
